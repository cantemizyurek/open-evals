...
- **Synthesizers** - Automatically generate test samples from your knowledge graph

### RAG Utilities

Essential tools for Retrieval-Augmented Generation workflows:
...
Dive deeper into the documentation to learn how to use Open Evals in your projects.
